...
var station_1 = __importDefault(require("../controllers/station"));
        ...
        try {
            node_fetch_1.default('https://www.rideindego.com/stations/json/')
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, station_1.default.createStation(response)];
                            case 1:
                                data = _a.sent();
                                if (data) {
        ...
        try {
            node_fetch_1.default('https://api.openweathermap.org/data/2.5/weather?q=Philadelphia&appid=' + config_1.default.auth.API_KEY)
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, station_1.default.getWeatherAndStationData(req.params.at)];
                            case 1:
                                data = _a.sent();
                                obj = {
                                    at: req.params.at,
        ...
        try {
            node_fetch_1.default('https://api.openweathermap.org/data/2.5/weather?q=Philadelphia&appid=' + config_1.default.auth.API_KEY)
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, station_1.default.getWeatherAndStationDataByKioskId(req.params.at, req.params.kioskId)];
                            case 1:
                                data = _a.sent();
                                obj = {
                                    at: req.params.at,
