...
var getWeatherAndStationData = function (at) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, station_1.default.findOne({ $or: [{ createdAt: at }, { createdAt: { $gt: at } }] })];
            case 1:
                station = _a.sent();
                return [2 /*return*/, station];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                check = 0;
                specficStation = {};
                for (i = 0; i < (stations === null || stations === void 0 ? void 0 : stations.data.features.length); i++) {
                    if ((stations === null || stations === void 0 ? void 0 : stations.data.features[i].properties.kioskId) == id) {
                        specficStation = stations === null || stations === void 0 ? void 0 : stations.data.features[i];
                        check = 1;
                        break;
                    }
                }
...
exports.default = { createStation: createStation, getWeatherAndStationData: getWeatherAndStationData, getWeatherAndStationDataByKioskId: getWeatherAndStationDataByKioskId };
